          ...
          <div className="bg-white rounded-lg shadow-md p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                className="bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center space-x-2"
              >
              ...
              <a 
                ...
                className="border-2 border-gray-900 text-gray-900 px-6 py-3 rounded-lg hover:bg-gray-900 hover:text-white transition-colors duration-200 flex items-center justify-center space-x-2"
              >
