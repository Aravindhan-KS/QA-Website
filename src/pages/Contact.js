      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Room No. 11, Third Floor</p>
                  <p className="text-gray-600">College of Engineering Guindy</p>
                  <p className="text-gray-600">Anna University, Chennai - 600025</p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div>
                      ...
                      <a href="tel:+919876543211" className="text-blue-600 hover:text-blue-800 transition-colors">
                        +91 98765 43211
                      </a>
                    </div>
                  </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent resize-vertical"
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Event Partnerships</h3>
            <p className="text-gray-600 mb-4">Collaborate with us for quiz events and competitions</p>
            <a 
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">Become a member and contribute to our quiz community</p>
            <a 
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Quiz Contributions</h3>
            <p className="text-gray-600 mb-4">Submit questions or suggest topics for our quiz sets</p>
            <a 
