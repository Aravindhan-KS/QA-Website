...
const QuizSets = () => {
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
      ...
      case 'Mixed': return 'bg-blue-900 text-blue-200';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-dark-card rounded-lg border border-dark-border p-6 text-center">
            <div className="text-3xl font-bold text-accent-blue mb-2">9</div>
            <div className="text-dark-text-secondary">Quiz Sets</div>
          </div>
          <div className="bg-dark-card rounded-lg border border-dark-border p-6 text-center">
            <div className="text-3xl font-bold text-purple-400 mb-2">1,390</div>
            <div className="text-dark-text-secondary">Total Questions</div>
          </div>
          <div className="bg-dark-card rounded-lg border border-dark-border p-6 text-center">
            <div className="text-3xl font-bold text-accent-green mb-2">8</div>
            <div className="text-dark-text-secondary">Categories</div>
          </div>
          <div className="bg-dark-card rounded-lg border border-dark-border p-6 text-center">
            <div className="text-3xl font-bold text-orange-400 mb-2">Free</div>
            <div className="text-dark-text-secondary">Downloads</div>
          </div>
        </div>
            ...
            <div key={quizSet.id} className="bg-dark-card rounded-lg border border-dark-border overflow-hidden hover:border-accent-blue transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="w-full bg-accent-blue text-white py-3 px-4 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center justify-center space-x-2"
                >
        ...
        <div className="mt-16 text-center">
          <div className="bg-dark-card rounded-lg border border-dark-border p-8 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-dark-text mb-4">Need Custom Quiz Sets?</h2>
