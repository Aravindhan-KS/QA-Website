...
const NewArticles = () => {
 ...
 const categoryStyles = {
    ...
    'Business': { bg: 'bg-orange-500', hoverBg: 'hover:bg-orange-500/90', shadow: 'hover:shadow-orange-500/50' },
    'Arts & Literature': { bg: 'bg-pink-500', hoverBg: 'hover:bg-pink-500/90', shadow: 'hover:shadow-pink-500/50' },
    'Sports': { bg: 'bg-red-500', hoverBg: 'hover:bg-red-500/90', shadow: 'hover:shadow-red-500/50' },
    'History & Geography': { bg: 'bg-indigo-500', hoverBg: 'hover:bg-indigo-500/90', shadow: 'hover:shadow-indigo-500/50' },
    'Entertainment': { bg: 'bg-yellow-500', hoverBg: 'hover:bg-yellow-500/90', shadow: 'hover:shadow-yellow-500/50' },
    'Current Affairs': { bg: 'bg-teal-500', hoverBg: 'hover:bg-teal-500/90', shadow: 'hover:shadow-teal-500/50' },
