      ...
      <div className="p-6">
        ...
        {event.reportUrl && (
          <a
            ...
            className="w-full inline-flex items-center justify-center space-x-2 bg-accent-cyan text-black py-2 px-4 rounded-lg 
                       hover:bg-accent-cyan/90 hover:shadow-lg transition-all duration-200"
          >
