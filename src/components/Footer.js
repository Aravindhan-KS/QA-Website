        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-gray-900 font-bold text-sm">QA</span>
              </div>
              <span className="font-bold text-xl">Quizzers Anonymous</span>
            </div>
            ...
            <div className="space-y-2">
              <p className="text-sm text-gray-400">Room No. 11, Third Floor</p>
              <p className="text-sm text-gray-400">College of Engineering Guindy</p>
              <p className="text-sm text-gray-400">Anna University, Chennai</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/quiz-sets" className="text-gray-300 hover:text-white transition-colors">Quiz Sets</a></li>
