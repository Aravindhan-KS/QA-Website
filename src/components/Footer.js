        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><a href="/new-articles" className="text-dark-text-secondary hover:text-accent-blue">Articles</a></li>
              ...
              <li><a href="/contact" className="text-dark-text-secondary hover:text-accent-blue">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              >
                {/* SlideShare Logo */}
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 512 512" fill="currentColor">
